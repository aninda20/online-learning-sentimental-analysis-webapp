...
def main():
    ...
    #st.title("Sentimental analysis on Online learning using Social media during Covid-19")
    #st.subheader("Select an online learning topic from wordcloud which you'd like to get the sentiment analysis on :")
    ...
    consumer_key = "6CSpIyJJcXnFM7vDy3sb3K2Rc"
    consumer_secret = "qhs2sdVzFRqjKbHI3THARslFCf0NuMcsXhZZ2hyGKFPJm26B66"
    access_token = "1395915383224209409-wmYnr3YKAKdDQjHmDySv3CYRuCWtuK"
    access_token_secret = "XoS2dAiuGci4rpxD3pxD0cCJNjUSqsHUnvF4Uk57Ol2DP"
    ...
    if Topic == ("distance learning") or Topic == ("online teaching") or Topic == ("online education") or Topic == ("online course") or Topic == ("online semester") or Topic == ("distance course") or Topic == ("distance education") or Topic == ("online class") or Topic == ("e-learning") or Topic == ("e learning") or Topic == ("#distancelearning") or Topic == ("#onlineschool") or Topic == ("#onlineteaching") or Topic == ("#virtuallearning") or Topic == ("#onlineducation") or Topic == ("#distanceeducation") or Topic == ("#OnlineClasses") or Topic == ("#DigitalLearning") or Topic == ("#elearning") or Topic == ("#onlinelearning"):
    ...
    # else:
	# 	print("Enter only the terms from wordcloud")
